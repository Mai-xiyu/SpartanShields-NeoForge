...
public class ObsidianShieldItem extends BasicShieldItem {
    ...
    private static final ResourceLocation MOVE_SPEED_MODIFIER = ResourceLocation.tryBuild(ModSpartanShields.ID, "obsidian_shield_move_speed");
    private static final ResourceLocation KNOCKBACK_MODIFIER = ResourceLocation.tryBuild(ModSpartanShields.ID, "obsidian_shield_knockback");
