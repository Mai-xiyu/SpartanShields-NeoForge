...
public class TierSS implements Tier {
    ...
    public static final TierSS STONE = new TierSS(Tiers.STONE, Tags.Items.COBBLESTONES);
    ...
    public static final TierSS OBSIDIAN = new TierSS(1024, 5.0f, 1.5f, 5, Tags.Items.OBSIDIANS);
    ...
    public TierSS(int durabilityIn, float speedIn, float attackDamageIn, int enchantabilityIn, TagKey<Item> repairMaterialTag) {
        ...
        this.repairTag = repairMaterialTag;
        this.repairMaterial = new LazyLoadedValue<>(() -> Ingredient.of(repairMaterialTag));
    }
    ...
    public @NotNull TagKey<Block> getIncorrectBlocksForDrops() {
        // Shields don't mine blocks, so return a generic tag
