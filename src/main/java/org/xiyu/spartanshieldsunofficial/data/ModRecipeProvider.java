...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(@NotNull RecipeOutput output) {
        ...
        TagKey<Item> cobblestone = ItemTags.create(ResourceLocation.parse("forge:cobblestones"));
        TagKey<Item> copperIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/copper"));
        TagKey<Item> ironIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/iron"));
        TagKey<Item> goldIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/gold"));
        TagKey<Item> diamond = ItemTags.create(ResourceLocation.parse("forge:gems/diamond"));
        TagKey<Item> netheriteIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/netherite"));
        TagKey<Item> obsidian = ItemTags.create(ResourceLocation.parse("forge:obsidians"));

        TagKey<Item> tinIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/tin"));
        TagKey<Item> bronzeIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/bronze"));
        TagKey<Item> steelIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/steel"));
        TagKey<Item> silverIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/silver"));
        TagKey<Item> electrumIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/electrum"));
        TagKey<Item> leadIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/lead"));
        TagKey<Item> nickelIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/nickel"));
        TagKey<Item> invarIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/invar"));
        TagKey<Item> constantanIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/constantan"));
        TagKey<Item> platinumIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/platinum"));
        TagKey<Item> aluminumIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/aluminum"));

        TagKey<Item> manasteelIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/manasteel"));
        TagKey<Item> terrasteelIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/terrasteel"));
        TagKey<Item> elementiumIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/elementium"));

        TagKey<Item> osmiumIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/osmium"));
        TagKey<Item> lapis = ItemTags.create(ResourceLocation.parse("forge:gems/lapis"));
        TagKey<Item> refinedGlowstoneIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/refined_glowstone"));
        TagKey<Item> refinedObsidianIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/refined_obsidian"));

        TagKey<Item> signalumIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/signalum"));
        TagKey<Item> lumiumIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/lumium"));
        TagKey<Item> enderiumIngot = ItemTags.create(ResourceLocation.parse("forge:ingots/enderium"));
    ...
    private void conditionalUpgradeRecipe(ItemLike result, ItemLike baseShield, TagKey<Item> material, String group, String unlockName, String disabledName, boolean isModded) {
        ...
        ConditionalShapedRecipeBuilder.shaped(result).
                ...
                condition(new NotCondition(new TagEmptyCondition(material))).
    ...
    private void mekanismShieldUpgradeRecipe(ItemLike result, ItemLike baseShield, Item alloy, Item controlCircuit, Item energyTablet, TagKey<Item> steelIngot, String unlockName) {
        ...
        // Simplified version without conditional output - conditions handled via ConditionalShapedRecipeBuilder
