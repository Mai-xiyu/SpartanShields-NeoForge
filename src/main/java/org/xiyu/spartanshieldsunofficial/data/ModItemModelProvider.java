...
public class ModItemModelProvider extends ItemModelProvider {
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, ModSpartanShields.ID, existingFileHelper);
    }
    ...
    protected void registerModels() {
        List.of(ModItems.WOODEN_BASIC_SHIELD, ModItems.STONE_BASIC_SHIELD, ModItems.COPPER_BASIC_SHIELD, ModItems.IRON_BASIC_SHIELD, ModItems.GOLDEN_BASIC_SHIELD, ModItems.DIAMOND_BASIC_SHIELD, ModItems.NETHERITE_BASIC_SHIELD, ModItems.OBSIDIAN_BASIC_SHIELD,
                ...
                .forEach((shield) -> this.createBasicShieldModel(shield.get()));
        ...
        List.of(ModItems.MANASTEEL_BASIC_SHIELD, ModItems.TERRASTEEL_BASIC_SHIELD, ModItems.ELEMENTIUM_BASIC_SHIELD)
                .forEach((shield) -> this.createModdedBasicShieldModel(shield.get(), Constants.Botania_ModID));
        ...
        List.of(ModItems.LAPIS_BASIC_SHIELD, ModItems.OSMIUM_BASIC_SHIELD, ModItems.REFINED_GLOWSTONE_BASIC_SHIELD, ModItems.REFINED_OBSIDIAN_BASIC_SHIELD)
                .forEach((shield) -> this.createModdedBasicShieldModel(shield.get(), Constants.Mekanism_ModID));
        ...
        List.of(ModItems.BASIC_MEKANISTS_BASIC_SHIELD, ModItems.ADVANCED_MEKANISTS_BASIC_SHIELD, ModItems.ELITE_MEKANISTS_BASIC_SHIELD, ModItems.ULTIMATE_MEKANISTS_BASIC_SHIELD)
                .forEach((shield) -> this.createMekanismPoweredBasicShieldModel(shield.get()));

        // EnderIO Shields
        this.createEnderIOPoweredBasicShieldModel(ModItems.DARK_STEEL_RIOT_BASIC_SHIELD.get());
        ...
        List.of(ModItems.WOODEN_TOWER_SHIELD, ModItems.STONE_TOWER_SHIELD, ModItems.COPPER_TOWER_SHIELD, ModItems.IRON_TOWER_SHIELD, ModItems.GOLDEN_TOWER_SHIELD, ModItems.DIAMOND_TOWER_SHIELD, ModItems.NETHERITE_TOWER_SHIELD, ModItems.OBSIDIAN_TOWER_SHIELD,
                        ...
                        ModItems.DARK_STEEL_RIOT_TOWER_SHIELD)
                .forEach((shield) -> this.createTowerShieldModel(shield.get()));
    }

    protected ResourceLocation createBasicShieldModel(Item itemIn) {
        String itemPath = BuiltInRegistries.ITEM.getKey(itemIn).getPath();
        ModelFile blockingModel = this.withExistingParent(itemPath + "_blocking", ResourceLocation.fromNamespaceAndPath(ModSpartanShields.ID, "basic_shield_base_blocking"))
                .texture("layer0", "item/" + itemPath);
        return this.withExistingParent(itemPath, ResourceLocation.fromNamespaceAndPath(ModSpartanShields.ID, "basic_shield_base"))
                .texture("layer0", "item/" + itemPath)
                .override().predicate(ResourceLocation.parse("blocking"), 1.0f).model(blockingModel).end()
                .getLocation();
    }
    ...
    protected ResourceLocation createMekanismPoweredBasicShieldModel(Item itemIn) {
        String itemPath = BuiltInRegistries.ITEM.getKey(itemIn).getPath();
        ModelFile blockingModel = this.getExistingFile(ResourceLocation.fromNamespaceAndPath(ModSpartanShields.ID, "mekanists_basic_shield_base_blocking"));
        ModelFile deactivatedModel = this.getExistingFile(ResourceLocation.fromNamespaceAndPath(ModSpartanShields.ID, "mekanists_basic_shield_base_deactivated"));
        ModelFile deactivatedBlockingModel = this.getExistingFile(ResourceLocation.fromNamespaceAndPath(ModSpartanShields.ID, "mekanists_basic_shield_base_deactivated_blocking"));
        ResourceLocation disabled = ResourceLocation.parse("disabled");
        ResourceLocation blocking = ResourceLocation.parse("blocking");
        return this.withExistingParent(itemPath, ResourceLocation.fromNamespaceAndPath(ModSpartanShields.ID, "mekanists_basic_shield_base"))
                .texture("layer0", "item/mekanism/mekanists_basic_shield_base")
                .texture("layer1", "item/mekanism/mekanists_basic_shield_lights_on")
    ...
    protected ResourceLocation createEnderIOPoweredBasicShieldModel(Item itemIn) {
        ...
        ModelFile blockingModel = this.withExistingParent(itemPath + "_blocking", ResourceLocation.fromNamespaceAndPath(ModSpartanShields.ID, "basic_shield_base_blocking"))
                .texture("layer0", baseTexture).texture("layer1", activatedTexture);
        ModelFile deactivatedModel = this.withExistingParent(itemPath + "_deactivated", ResourceLocation.fromNamespaceAndPath(ModSpartanShields.ID, "basic_shield_base"))
                .texture("layer0", baseTexture).texture("layer1", deactivatedTexture);
        ModelFile deactivatedBlockingModel = this.withExistingParent(itemPath + "_deactivated_blocking", ResourceLocation.fromNamespaceAndPath(ModSpartanShields.ID, "basic_shield_base_blocking"))
                .texture("layer0", baseTexture).texture("layer1", deactivatedTexture);
        ResourceLocation disabled = ResourceLocation.parse("disabled");
        ResourceLocation blocking = ResourceLocation.parse("blocking");
        return this.withExistingParent(itemPath, ResourceLocation.fromNamespaceAndPath(ModSpartanShields.ID, "basic_shield_base"))
    ...
    protected ResourceLocation createTowerShieldModel(Item itemIn) {
        String itemPath = BuiltInRegistries.ITEM.getKey(itemIn).getPath();
        ModelFile blockingModel = this.getExistingFile(ResourceLocation.fromNamespaceAndPath(ModSpartanShields.ID, "tower_shield_base_blocking"));
        return this.withExistingParent(itemPath, ResourceLocation.fromNamespaceAndPath(ModSpartanShields.ID, "tower_shield_base"))
                .override().predicate(ResourceLocation.parse("blocking"), 1.0f).model(blockingModel).end()
                .getLocation();
    }
