...
public class ModSoundDefinitionsProvider extends SoundDefinitionsProvider 
{
	...
	{
		add(ModSounds.SHIELD_BASH_HIT, SoundDefinition.definition().subtitle("subtitle.spartanshieldsunofficial.shield.bash.hit").
		...
		add(ModSounds.LOC_SHIELD_BASH_MISS, SoundDefinition.definition().subtitle("subtitle.spartanshieldsunofficial.shield.bash.miss").
		...
		add(ModSounds.SHIELD_PAYBACK_CHARGE, SoundDefinition.definition().subtitle("subtitle.spartanshieldsunofficial.shield.payback.charge").
