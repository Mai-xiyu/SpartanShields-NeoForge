...
@EventBusSubscriber(modid = org.xiyu.spartanshieldsunofficial.ModSpartanShields.ID)
public class CommonEventHandler 
{
	...
	{
		float currentDmg = activeStack.getOrDefault(ModDataComponents.PAYBACK_DAMAGE.get(), 0.0f);
		...
		activeStack.set(ModDataComponents.PAYBACK_DAMAGE.get(), currentDmg);
