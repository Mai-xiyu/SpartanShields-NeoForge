...
public class ModCreativeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> TAB = REGISTER.register("tab", () -> CreativeModeTab.builder().title(Component.translatable("itemGroup." + ModSpartanShields.ID))
    ...
    private static ItemStack fullChargedItemStack(RegistryObject<FEPoweredShieldItem> reg) {
        ...
        ModDataComponents.setStoredEnergy(stack, item.getFECapacity(stack));
        return stack;
    }
}
