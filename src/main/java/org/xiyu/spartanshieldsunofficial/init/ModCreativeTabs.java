...
public class ModCreativeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> TAB = REGISTER.register("tab", () -> CreativeModeTab.builder().title(Component.translatable("itemGroup." + ModSpartanShields.ID))
    ...
    private static ItemStack toItemStack(DeferredHolder<net.minecraft.world.item.Item, ShieldBaseItem> item) {
        return new ItemStack(item.get());
    }

    private static ItemStack unchargedItemStack(DeferredHolder<net.minecraft.world.item.Item, FEPoweredShieldItem> item) {
        return new ItemStack(item.get());
    }

    private static ItemStack fullChargedItemStack(DeferredHolder<net.minecraft.world.item.Item, FEPoweredShieldItem> reg) {
        FEPoweredShieldItem item = reg.get();
        ItemStack stack = new ItemStack(item);
        stack.set(ModDataComponents.STORED_ENERGY.get(), item.getFECapacity(stack));
        return stack;
    }
}
