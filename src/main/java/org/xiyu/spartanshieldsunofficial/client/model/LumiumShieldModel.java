...
//    public ModelRenderer plateRight;
    ...
    public LumiumShieldModel(ModelPart rootModel) {
        ...
        this.plateLeft2 = rootModel.getChild(PART_PLATE_LEFT_2);
        this.plateRight = rootModel.getChild(PART_PLATE_RIGHT);
        this.plateRight2 = rootModel.getChild(PART_PLATE_RIGHT_2);
    }
    ...
    public void renderExtraParts(PoseStack mStack, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn,
        ...
        this.plateLeft2.render(mStack, vertexBuilder, packedLightIn, packedOverlayIn, color);
        this.plateRight.render(mStack, vertexBuilder, packedLightIn, packedOverlayIn, color);
        this.plateRight2.render(mStack, vertexBuilder, packedLightIn, packedOverlayIn, color);
    }
