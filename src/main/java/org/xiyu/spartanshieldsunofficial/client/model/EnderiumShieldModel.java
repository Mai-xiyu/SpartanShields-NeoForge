...
//    public ModelRenderer plateRight;
    ...
    @Override
    			...
    			int color) 
    	{
    		...
    		plateLeft.render(mStack, vertexBuilder, packedLightIn, packedOverlayIn, color);
    		plateRight.render(mStack, vertexBuilder, packedLightIn, packedOverlayIn, color);
    		plateUpLeft.render(mStack, vertexBuilder, packedLightIn, packedOverlayIn, color);
    		plateUpRight.render(mStack, vertexBuilder, packedLightIn, packedOverlayIn, color);
    		plateDown.render(mStack, vertexBuilder, packedLightIn, packedOverlayIn, color);
    	}
