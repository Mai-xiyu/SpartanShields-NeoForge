...
//    public ModelRenderer plateRight;
    ...
    public EnderiumShieldModel(ModelPart rootModel) {
        ...
        this.plateLeft = rootModel.getChild(PART_PLATE_LEFT);
        this.plateRight = rootModel.getChild(PART_PLATE_RIGHT);
        this.plateUpLeft = rootModel.getChild(PART_PLATE_UP_LEFT);
        this.plateUpRight = rootModel.getChild(PART_PLATE_UP_RIGHT);
        this.plateDown = rootModel.getChild(PART_PLATE_DOWN);
    }
    ...
    public void renderExtraParts(PoseStack mStack, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn,
        ...
        this.plateLeft.render(mStack, vertexBuilder, packedLightIn, packedOverlayIn, color);
        this.plateRight.render(mStack, vertexBuilder, packedLightIn, packedOverlayIn, color);
        this.plateUpLeft.render(mStack, vertexBuilder, packedLightIn, packedOverlayIn, color);
        this.plateUpRight.render(mStack, vertexBuilder, packedLightIn, packedOverlayIn, color);
        this.plateDown.render(mStack, vertexBuilder, packedLightIn, packedOverlayIn, color);
    }
