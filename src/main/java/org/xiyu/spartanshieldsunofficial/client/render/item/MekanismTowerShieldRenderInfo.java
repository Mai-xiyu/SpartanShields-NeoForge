...
public class MekanismTowerShieldRenderInfo extends TowerShieldRenderInfo {
    ...
    protected static final RenderType LIGHTS_ON = RenderType.eyes(ResourceLocation.tryBuild(ModSpartanShields.ID, "textures/entity/mekanism/mekanists_tower_shield_lights_on.png"));
    protected static final RenderType LIGHTS_OFF = RenderType.entityTranslucent(ResourceLocation.tryBuild(ModSpartanShields.ID, "textures/entity/mekanism/mekanists_tower_shield_lights_off.png"));


    public MekanismTowerShieldRenderInfo(float rIn, float gIn, float bIn) {
        super(ResourceLocation.tryBuild(ModSpartanShields.ID, "entity/mekanism/mekanists_tower_shield_nopattern"),
                ResourceLocation.tryBuild(ModSpartanShields.ID, "entity/mekanism/mekanists_tower_shield_pattern"));
        this.r = rIn;
        this.g = gIn;
        this.b = bIn;
    }
